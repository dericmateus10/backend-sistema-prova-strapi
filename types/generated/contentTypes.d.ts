...
export interface ApiCapabilitiesSaepCapabilitiesSaep
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'lembrar'>;
    ...
    >;
    ucs: Schema.Attribute.Relation<'manyToMany', 'api::uc.uc'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCapabilityCapability extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    performance_standards: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    ucs: Schema.Attribute.Relation<'oneToMany', 'api::uc.uc'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFunctionsSenaiFunctionsSenai
  extends Struct.CollectionTypeSchema {
...
export interface ApiModulesUcModulesUc extends Struct.CollectionTypeSchema {
  collectionName: 'modules_ucs';
  info: {
    displayName: 'ModulesUC';
    pluralName: 'modules-ucs';
...
export interface ApiPerformanceStandardPerformanceStandard
  extends Struct.CollectionTypeSchema {
...
export interface ApiSubFunctionSenaiSubFunctionSenai
  extends Struct.CollectionTypeSchema {
...
export interface ApiUcUc extends Struct.CollectionTypeSchema {
  collectionName: 'ucs';
  info: {
    displayName: 'UC';
    pluralName: 'ucs';
  ...
  attributes: {
    ...
    description: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::uc.uc'> &
      Schema.Attribute.Private;
    modules_uc: Schema.Attribute.Relation<
      'manyToOne',
      'api::modules-uc.modules-uc'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::functions-senai.functions-senai': ApiFunctionsSenaiFunctionsSenai;
